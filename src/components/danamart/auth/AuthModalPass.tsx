...
const AuthModalPass: React.FC<Props> = ({
  open,
  handleOpen,
  setPage
}: Props) => {
      ...
      <DialogBody className="flex flex-col gap-4 p-10 items-center">
        ...
        <div className="flex flex-col gap-2">
          <Typography className="text-center font-poppins font-semibold text-xl text-[#262626]">
            {t('danamart.forgotPassword.authForgotPass.modal.title1')}
          </Typography>
          <Typography className="text-center font-poppins font-normal text-sm text-[#7C7C7C]">
            {t('danamart.forgotPassword.authForgotPass.modal.title2')}
          </Typography>
        </div>
        <Link href={'/danamart'} className="w-full">
          <Button
          ...
          >
            {t('danamart.forgotPassword.authForgotPass.modal.close')}
          </Button>
        </Link>
      </DialogBody>
    </Dialog>
