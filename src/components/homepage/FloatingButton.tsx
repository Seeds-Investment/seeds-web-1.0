        ...
        {isGuidanceModal && (
          ...
          />
            ...
            <div className={`relative w-[20px] h-[40px] ${isExpanded ? "block" : "hidden"}`}>
                ...
                <div onClick={ async() => await router.push(`/homepage/social/${id as string}`)} className='absolute right-[20px] top-0 bottom-0 m-auto w-[45px] h-[45px] rounded-full bg-[#3AC4A0] flex justify-center items-center cursor-pointer hover:shadow-xl duration-300'>
                    <Image
                        width={100}
                        height={100}
                        alt=""
