...
const InputPin: React.FC<InputPinProps> = ({
  ...
  const buttonClasses = `z-10 flex justify-center items-center w-10 h-10 transition-colors duration-300  rounded-full text-3xl font-semibold hover:bg-gray-200 ${
    ...
    >
      <div className="max-w-max mx-auto mt-6 mb-36">
        ...
        <div className="relative flex items-center sm:mb-8 mb-10">
          <button
            onClick={onCancel}
            className="absolute left-0 w-10 transition-colors duration-300 rounded-md hover:bg-gray-200 active:bg-gray-300"
          >
