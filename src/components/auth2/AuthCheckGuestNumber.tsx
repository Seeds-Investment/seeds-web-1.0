...
interface IAuthCheckGuestNumber {
  className: string;
...
const AuthCheckGuestNumber: React.FC<IAuthCheckGuestNumber> = ({
  className,
  setSelect,
  formData,
  setFormData,
...
export default AuthCheckGuestNumber;
