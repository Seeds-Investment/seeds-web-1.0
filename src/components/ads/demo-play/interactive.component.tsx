...
const Interactive = (): React.ReactElement => {
  const data = [
    { img: handclapping, text: 'Play Daily Quizzes & Win Rewards' },
    { img: pinwheel, text: 'Spin & Win Prizes' },
    { img: gift2, text: 'Track & Claim Your Rewards' }
  ];
  return (
    <div className="flex flex-col md:flex-row justify-center items-center gap-5 py-5 px-4 lg:px-20 h-screen text-neutral-medium">
      <div className="flex flex-col gap-8">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm sm:text-base">
            Ready to test your skills? Our app is designed with features to make
      ...
      <Image src={phone2} alt="phone2" className='h-2/3 sm:h-fit sm:w-1/2 xl:w-2/3' />
    </div>
  );
};
