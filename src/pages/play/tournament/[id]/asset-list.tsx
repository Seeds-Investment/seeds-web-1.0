...
const AssetList = (): React.ReactElement => {
  ...
  const [assetActiveSort, setAssetActiveSort] = useState(SortingFilter.ASCENDING);
    ...
    <>
      <div className='w-full flex flex-col justify-center items-center rounded-xl font-poppins p-5 bg-white'>
        ...
        <div className='w-full flex gap-2 mt-4'>
          ...
          />
          <Image onClick={() => { handleShowFilters(); }} alt="" src={IconFilter} className='w-[30px] cursor-pointer'/>
        </div>
