    ...
    <div className="flex flex-col md:flex-row justify-evenly items-center px-4 py-10 lg:px-20 lg:py-11 bg-gradient-to-b from-[#67E3B6] to-[#19AEAE]">
      ...
      <div className='flex flex-col gap-10 justify-center items-center'>
        <div className='flex flex-col gap-4 text-center'>
          <p className='font-semibold text-2xl lg:text-3xl xl:text-5xl text-white'>Siap Wujudkan karier impian kamu di industri Web3?</p>
          <p className='text-sm lg:text-base xl:text-2xl text-white'>Daftarkan dirimu sekarang juga!</p>
        </div>
        <CountdownTimer targetDate={new Date('2025-04-27').toISOString()}/>
