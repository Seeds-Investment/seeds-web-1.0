'use client';
import Sapling from '@/assets/landing-page/sapling.png';
import Seedling from '@/assets/landing-page/seedling.png';
import Seeds from '@/assets/landing-page/seeds.png';
import Sprout from '@/assets/landing-page/sprout.png';
import Tree from '@/assets/landing-page/tree.png';
...
export default function Section3(): React.ReactElement {
  ...
  return (
    <section className="h-auto min-w-full cursor-default font-poppins text-center relative overflow-hidden">
