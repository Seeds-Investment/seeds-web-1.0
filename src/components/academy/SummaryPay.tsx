            ...
            <div className="px-4">
              <div className="grid grid-cols-2">
                <div>
                  ...
                  <div className="mb-4">Discount</div>
                </div>
                <div>
                  <div className="text-right mt-4 mb-4">IDR 100.000</div>
                  <div className="text-right mb-4">IDR 95.000</div>
                </div>
              </div>
              <hr className="border-t-2" />
              <div className="grid grid-cols-2 my-4">
                <div className="font-bold">Total Cost</div>
                <div className="text-right font-bold">IDR 95.000</div>
              </div>
              <div className="mb-10 relative">
                ...
                <input
                  type="text"
                  className="pl-10 pr-4 py-3 rounded-xl border border-2 w-full"
