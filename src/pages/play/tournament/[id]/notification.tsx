...
const NotificationWinner: React.FC = () => {
  ...
  return (
    <div
      className="h-screen md:h-auto w-full md:p-5 flex flex-col items-center md:relative absolute bottom-0 m-0 rounded-b-none md:rounded-2xl min-w-full"
      style={{
    ...
    >
      <div className="flex flex-col items-center md:gap-5 gap-4 p-0 h-full w-full">
        <div className="overflow-auto flex flex-col items-center h-full w-full">
          ...
          <Typography className="font-poppins text-lg text-[#262626] mb-4 text-justify px-8">
            {dataResult.prize > 0
              ? t('quiz.tax')
