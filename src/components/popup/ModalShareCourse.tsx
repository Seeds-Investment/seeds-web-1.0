    ...
    return (
      <>
        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 flex items-end justify-center">
          <div className="bg-white rounded-t-3xl overflow-hidden w-full border p-6">
            ...
            <div className="flex flex-col gap-2 justify-center px-2 lg:px-8 pt-2 items-center text-center">
              ...
              <div className="w-full h-fit flex mb-4">
                <input
                  ...
                  className="block w-full text-[#262626] h-10 leading-4 placeholder:text-[#BDBDBD] focus:outline-0 disabled:bg-[#E9E9E9] p-4 rounded-xl border border-[#BDBDBD]"
                />
                <div
    ...
    return (
      <>
        ...
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 w-3/4 lg:w-1/2">
          <div className="bg-white rounded-3xl overflow-hidden w-full border p-6">
            <div className="flex justify-between mb-4">
              <Typography className="font-semibold text-lg">
                {t('academy.shareCourse')}
              </Typography>
