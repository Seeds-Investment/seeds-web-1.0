  ...
  return (
    <div className={className ?? 'relative'} style={style}>
      <textarea
        ...
        className={`peer h-full w-full resize-none rounded-[7px] border border-neutral-soft bg-transparent px-3 py-2.5 text-sm text-neutral-soft outline outline-0 transition-all placeholder:text-neutral-soft placeholder-shown:border placeholder-shown:border-neutral-soft placeholder-shown:border-t-neutral-soft focus:border-2 focus:border-seeds-button-green ${
          isWithoutLabel
            ? ''
