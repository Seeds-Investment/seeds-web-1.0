...
const SuccessPaymentPage: React.FC = () => {
  ...
  const getSelectedPayment = (
    ...
    const paymentSelected: PaymentList[] = eWalletList.filter(
    ...
    if (paymentSelected.length === 0 && paymentSelectedVA.length !== 0) {
      return paymentSelectedVA;
    } else if (paymentSelectedVA.length === 0 && paymentSelected.length !== 0) {
