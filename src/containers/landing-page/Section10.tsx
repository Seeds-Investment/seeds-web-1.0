    ...
    >
      ...
      >
        <div className="flex flex-col items-center justify-center">
          ...
          <div
            className={`w-full h-[400px] xl:h-[864px] pt-[90px] font-poppins relative lg:pb-20`}
          >
            ...
            <div className="w-full h-[217px] bg-gradient-to-bl from-[#92FFD7] to-[#AE90FF] bottom-[200px] inset-x-[0] absolute z-0 mx-auto xl:block hidden" />
