...
// funtion commet
function CommentView(item: ICommnet[]): React.ReactElement {
  ...
  return (
    <PageGradient defaultGradient className="w-full">
      <div className="relative mx-14">
        <div className="block bg-white mt-28 w-full rounded-xl p-20 absolute z-20 ">
          <div className="flex flex-row justify-start items-center gap-24">
            ...
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M12.7071 7.29289C13.0976 7.68342 13.0976 8.31658 12.7071 8.70711L8.41421 13H22C22.5523 13 23 13.4477 23 14C23 14.5523 22.5523 15 22 15H8.41421L12.7071 19.2929C13.0976 19.6834 13.0976 20.3166 12.7071 20.7071C12.3166 21.0976 11.6834 21.0976 11.2929 20.7071L5.29289 14.7071C4.90237 14.3166 4.90237 13.6834 5.29289 13.2929L11.2929 7.29289C11.6834 6.90237 12.3166 6.90237 12.7071 7.29289Z"
                fill="#262626"
              />
            </svg>
            <p className="text-2xl font-semibold font-poppins">Commet</p>
          </div>
          {/* profile */}
          {data.map((item, index) => (
            <div key={index}>
              <div className="flex flex-row mt-12 border-b-[1px] border-b-blue-gray-300">
                ...
                <div>
                  ...
                  <div className="mt-8">
                    ...
                    <div className="flex flex-row items-center justify-between gap-8 mt-7 mb-4">
                      ...
                      <div className="flex flex-row items-center gap-5">
                        ...
                        >
                          <path
                            d="M14.2153 0.814454C14.3188 0.81427 14.4213 0.834483 14.517 0.873938C14.6127 0.913393 14.6996 0.971317 14.7729 1.0444L22.5689 8.84041C22.7165 8.98808 22.7994 9.18835 22.7994 9.39716C22.7994 9.60597 22.7165 9.80623 22.5689 9.9539C21.8129 10.7099 20.8805 10.88 20.2017 10.88C19.923 10.88 19.6741 10.8516 19.4773 10.8186L14.5414 15.7545C14.6713 16.278 14.7556 16.8118 14.7933 17.3499C14.8658 18.4555 14.7429 20.0068 13.6594 21.0904C13.5117 21.238 13.3114 21.3209 13.1026 21.3209C12.8938 21.3209 12.6936 21.238 12.5459 21.0904L8.09035 16.6364L3.07885 21.6479C2.77174 21.955 1.15899 23.0685 0.85187 22.7614C0.544754 22.4543 1.65825 20.84 1.96536 20.5344L6.97686 15.5229L2.52289 11.0674C2.37527 10.9197 2.29233 10.7195 2.29233 10.5106C2.29233 10.3018 2.37527 10.1016 2.52289 9.9539C3.60646 8.87033 5.15779 8.74591 6.26341 8.81994C6.8015 8.85764 7.33531 8.94195 7.85883 9.07193L12.7947 4.1376C12.7535 3.89776 12.7325 3.6549 12.7317 3.41155C12.7317 2.73432 12.9018 1.80195 13.6594 1.0444C13.807 0.897188 14.0069 0.814499 14.2153 0.814454ZM14.4075 4.1376V4.14075C14.453 4.2793 14.4591 4.42776 14.4252 4.56958C14.3912 4.7114 14.3186 4.84101 14.2153 4.94398L8.64788 10.5099C8.54444 10.6129 8.41439 10.6851 8.27228 10.7185C8.13016 10.7518 7.98156 10.745 7.84308 10.6989H7.83993L7.81788 10.6926C7.66805 10.6477 7.51677 10.6077 7.3643 10.5729C6.9681 10.4804 6.56524 10.4194 6.15946 10.3902C5.49483 10.3461 4.8428 10.4028 4.30889 10.6264L12.9869 19.3028C13.2089 18.7673 13.2656 18.1169 13.2215 17.4522C13.1814 16.8896 13.08 16.3329 12.9192 15.7922L12.9129 15.7718V15.7702C12.8663 15.6315 12.8594 15.4826 12.8928 15.3402C12.9262 15.1977 12.9986 15.0674 13.1018 14.9638L18.6709 9.39637C18.7781 9.28847 18.9143 9.21395 19.063 9.18181C19.2117 9.14967 19.3665 9.16128 19.5088 9.21525L19.66 9.2499C19.797 9.27667 19.9875 9.30345 20.2017 9.30345C20.3813 9.30345 20.564 9.28612 20.7419 9.24045L14.3713 2.87134C14.3256 3.04931 14.3083 3.23358 14.3083 3.41155C14.309 3.65627 14.3419 3.89984 14.4059 4.13603L14.4075 4.1376Z"
                            fill="#484747"
                          />
                        </svg>
                        <svg
                        ...
                        >
                          <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                            d="M4.39969 2.71749C4.08142 2.71749 3.77618 2.83729 3.55113 3.05053C3.32608 3.26378 3.19965 3.55299 3.19965 3.85456V19.8381L9.7024 15.437C10.1197 15.1546 10.6802 15.1546 11.0974 15.437L17.6002 19.8381V3.85456C17.6002 3.55299 17.4737 3.26378 17.2487 3.05053C17.0236 2.83729 16.7184 2.71749 16.4001 2.71749H4.39969ZM1.85401 1.44248C2.52917 0.802753 3.44488 0.443359 4.39969 0.443359H16.4001C17.3549 0.443359 18.2707 0.802753 18.9458 1.44248C19.621 2.0822 20.0003 2.94985 20.0003 3.85456V22.0476C20.0003 22.4736 19.749 22.8638 19.3493 23.0587C18.9496 23.2536 18.4685 23.2205 18.1027 22.9729L10.3999 17.7597L2.69712 22.9729C2.33133 23.2205 1.85019 23.2536 1.45049 23.0587C1.05079 22.8638 0.799561 22.4736 0.799561 22.0476V3.85456C0.799561 2.94986 1.17886 2.0822 1.85401 1.44248Z"
                            fill="#484747"
                          />
                        </svg>
                      </div>
