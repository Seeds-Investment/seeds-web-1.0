...
export default function Section1(): React.ReactElement {
  ...
  return (
    <div className="w-full m-12 h-auto cursor-default">
      <div className="flex flex-col md:flex-row">
        <div className="w-1/2">
          <p className="font-poppins text-[48px] font-bold xl:mb-3 md:mb-8">
            Where{' '}
            <span className="font-poppins text-[48px] font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#9A76FE] to-[#4FE6AF] mr-2 xl:pb-4">
              Gaming
            </span>{' '}
            Meets{' '}
            <span className="font-poppins text-[48px] font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#9A76FE] to-[#4FE6AF] mr-2 xl:pb-4">
          ...
          <h1 className="font-poppins text-4xl mb-3 font-semibold text-[#3AC4A0]">
            {titles[currentSlide]}
          </h1>
          <p className="font-poppins font-normal mb-3 text-2xl md:mb-7">
