...
const ModalOTP: React.FC<Props> = ({
  ...
  return (
    ...
    >
      <button
        onClick={() => { setIsShowOTP(!isShowOTP); }}
      ...
      <Typography className="font-bold text-xl mb-4">{t(`${pathTranslation}.verification`)}</Typography>

      {/* Dropdown for OTP Type */}
      <div className="mb-4">
        <Typography className="mb-2">{t(`${pathTranslation}.selectType`)}</Typography>
