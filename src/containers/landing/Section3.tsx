      ...
      <div className="flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 md:mt-20">
          <div className="w-2/3 justify-center p-5 lg:w-full md:ml-10">
            ...
            <Button className="mt-4 z-30 top-[520px] left-[50px] capitalize text-md bg-seeds-purple rounded-full max-w-[250px] w-fit px-14 h-[50px] lg:font-bold lg:text-base">
              {t('button.joinNow')}
            </Button>
          </div>
        </div>
