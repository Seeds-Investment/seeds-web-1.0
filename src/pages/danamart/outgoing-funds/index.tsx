...
const OutgoingFunds = (): React.ReactElement => {
  ...
  const [isShowModalDetailOutgoingFunds, setIsShowModalDetailOutgoingFunds] =
    useState<boolean>(false);
  const [isShowModalWithdraw, setIsShowModalWithdraw] =
    useState<boolean>(false);
  ...
  const filteredData = outgoingFunds?.filter(outgoingFund => {
    const incomingFundString = JSON?.stringify(outgoingFund)?.toLowerCase();
  ...
  const dashboardCardData: Array<{
  ...
  }> = [
    {
      ...
      background:
        'bg-gradient-to-tr from-[#5263F9]/20 via-white to-[#4FE6AF]/20',
    ...
    },
    {
      ...
      background:
        'bg-gradient-to-tl from-[#5263F9]/20 via-white to-[#4FE6AF]/20',
    ...
    },
    {
      ...
      background:
        'bg-gradient-to-br from-[#5263F9]/20 via-white to-[#4FE6AF]/20',
                ...
                <thead>
                  <tr className="text-[#27A590] font-poppins bg-[#DCFCE4]">
                    ...
                    <th
                      className="text-center p-2 border border-gray-300 cursor-pointer"
                      onClick={() => {
                        handleSort('jml_withdraw');
                      }}
                    >
                      {t(`${pathTranslation}.table.text8`)}
                    </th>
                    <th
                      className="text-center p-2 border border-gray-300 cursor-pointer hidden md:table-cell"
                      onClick={() => {
                        handleSort('ket');
                      }}
                    >
                ...
                <tbody>
                  {paginatedData?.length > 0 ? (
                    paginatedData?.map((outcome, index) => (
                      ...
                      >
                        ...
                        <td className="p-2 border border-gray-300 text-right">{`IDR ${standartCurrency(
                          Number(outcome?.jml_withdraw ?? '0') ?? 0
                        )}`}</td>
                    ...
                    <tr>
                      <td
                        colSpan={3}
                        className="p-4 text-center text-gray-500 md:hidden table-cell"
                      >
                        {t(`${pathTranslation}.table.text1`)}
                      </td>
                      <td
                        colSpan={4}
                        className="p-4 text-center text-gray-500 hidden md:table-cell"
                      >
                        {t(`${pathTranslation}.table.text1`)}
                      </td>
                    </tr>
