...
const useBase64ToFileList = (): [FileList | null, (base64String: string, fileName?: string) => void] => {
  const [fileList, setFileList] = useState<FileList | null>(null);

  const base64ToFileList = useCallback((base64String: string, fileName: string = "image.png") => {
