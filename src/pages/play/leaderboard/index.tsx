    ...
    <>
      <div className="w-full h-auto justify-center cursor-default bg-white font-poppins">
        <div className="relative font-poppins bg-gradient-to-r from-[#10A8AD] to-[#79F0B8] rounded-2xl pt-5">
          ...
          />
          {activeTab !== 'all' && (
            <div className="bg-white text-[#3AC4A0] flex gap-1 text-xs ml-auto mr-2 md:mr-4 justify-center text-center items-center border border-1 p-1 border-[#27A590] rounded-full w-[130px] xl:w-[150px]">
          ...
          <div className="flex flex-row bg-[#2b4740] justify-center mx-auto text-center w-fit rounded-full items-center px-2 py-2 gap-1 my-4">
            <button
