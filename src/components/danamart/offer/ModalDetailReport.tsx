...
const ModalDetailReport: React.FC<Props> = ({
  ...
  return (
    ...
    >
      <button
        onClick={() => {
          setIsShowDetailReport(!isShowDetailReport);
        }}
          ...
          reportData[selectedReport]?.jenisLaporan === 'Laporan Berkala' ? (
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <a
                  href={`https://dev.danamart.id/development/dm-scf-api/writable/uploads/${
                    reportData[selectedReport]?.modalDetail?.dokumen ?? ''
                  }`}
                  target="_blank"
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html:
                      reportData[selectedReport]?.modalDetail?.dm_ebus_01004 ??
                      ''
                  }}
                />
              </div>
              <div>
                ...
                <a
                  href={`https://dev.danamart.id/development/dm-scf-api/writable/uploads/${
                    reportData[selectedReport]?.modalDetail?.dm_ebus_01005 ?? ''
                  }`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-poppins text-seeds-button-green break-words"
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-0">
              <div className="w-full md:w:1/2">
                ...
                <a
                  href={`https://dev.danamart.id/development/dm-scf-api/writable/uploads/${
                    reportData[selectedReport]?.modelDetail?.dataDok
                      ?.RealisasiPenggunaanDana ?? ''
                  }`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-poppins text-seeds-button-green break-words"
