...
const IncomingFunds = (): React.ReactElement => {
  ...
  const [isShowModalDetailIncomeFunds, setIsShowModalDetailIncomeFunds] =
    useState<boolean>(false);
  const [isShowDownloadReport, setIsShowDownloadReport] =
    useState<boolean>(false);
  ...
  const selectedBank = bankList[selectedBankIndex]
    ?.name as keyof typeof bankInstructions;
  const bankData =
