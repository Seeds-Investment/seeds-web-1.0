    ...
    >
      ...
      <div className="my-4 md:my-2 p-0 md:p-4 flex flex-col gap-2">
        <div className="flex justify-between">
          <Typography className="font-poppins text-[#677788]">{t(`${pathTranslation}.text1`)}</Typography>
        ...
        <div className="flex justify-between">
          <Typography className="font-poppins text-[#677788]">{t(`${pathTranslation}.text2`)}</Typography>
          <Typography className="font-poppins text-[#687889] font-medium text-right">
            {data?.inisial}
          </Typography>
        </div>
        ...
        <div className="flex justify-between">
          <Typography className="font-poppins text-[#677788]">{t(`${pathTranslation}.text3`)}</Typography>
          <Typography className="font-poppins text-[#687889] font-medium text-right">
            {data?.lokasi}
          </Typography>
        </div>
        ...
        <div className="flex justify-between">
          <Typography className="font-poppins text-[#677788]">{t(`${pathTranslation}.text4`)}</Typography>
          <Typography className="font-poppins text-[#687889] font-medium text-right">
            {data?.dm_pem_05001}
          </Typography>
        </div>
