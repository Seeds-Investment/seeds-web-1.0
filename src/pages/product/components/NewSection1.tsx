...
const NewSection1: React.FC = () => {
  ...
  return (
    <section
      ref={ref}
      className="flex md:flex-row flex-col-reverse items-center w-full justify-between 2xl:h-[770px]"
    >
      <div
      ...
      >
        ...
        <Typography className="text-[#262626] xl:text-2xl text-base font-poppins font-normal md:text-left text-center mx-4 xl:mx-0">
